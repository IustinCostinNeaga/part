  ...
  import Cookies from 'js-cookie'
    ...
    methods: {
      async visualizzaGruppi(){
          ...
          let resp2 = await fetch('http://localhost:8080/group',
          {
            method: 'GET',
          ...
          let resp3 = await fetch('http://localhost:8080/user?id='+this.gruppiMaster[i].master,
            {
              method: 'GET',
              headers: {'Content-Type': 'application/json'},
              credentials:'include',
            ...
            for(let j=0; j<this.gruppiMaster[i].characters.length; j++){
              let resp4 = await fetch('http://localhost:8080/user?id='+this.gruppiMaster[i].characters[j].user,
              {
                method: 'GET',
                headers: {'Content-Type': 'application/json'},
                credentials:'include',
          ...
          let resp3 = await fetch('http://localhost:8080/user?id='+this.gruppiPlayer[i].master,
            {
              method: 'GET',
              headers: {'Content-Type': 'application/json'},
              credentials:'include',
            ...
            for(let j=0; j<this.gruppiPlayer[i].characters.length; j++){
              let resp4 = await fetch('http://localhost:8080/user?id='+this.gruppiPlayer[i].characters[j].user,
              {
                method: 'GET',
                headers: {'Content-Type': 'application/json'},
                credentials:'include',
        ...
        async richiesta(group, request){
          let resp3 = await fetch('http://localhost:8080/user?id='+request.user,
            {
              method: 'GET',
              headers: {'Content-Type': 'application/json'},
              credentials:'include',
        ...
        async removePlayer(group, player){
          let resp3 = await fetch('http://localhost:8080/user?id='+player.user,
            {
              method: 'GET',
              headers: {'Content-Type': 'application/json'},
              credentials:'include',
