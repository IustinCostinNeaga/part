<script>
  import Cookies from 'js-cookie'
    ...
    methods: {
      async caricaPgs(){
        this.personaggi=[];
          let resp1 = await fetch('http://localhost:8080/character',
          {
            method: 'GET',
        ...
        let data1 = await resp1.json();
          ...
          let resp3 = await fetch('http://localhost:8080/user?id='+this.gruppi[i].master,
            {
              method: 'GET',
              headers: {'Content-Type': 'application/json'},
              credentials:'include',
            ...
            for(let j=0; j<this.gruppi[i].characters.length; j++){
              ...
              let resp4 = await fetch('http://localhost:8080/user?id='+this.gruppi[i].characters[j].user,
              {
                method: 'GET',
                headers: {'Content-Type': 'application/json'},
                credentials:'include',
