    ...
    methods: {
      ...
      async ccercaGruppo(){
        this.gruppi=[];
          this.gruppiMaster = [],
          this.gruppiPlayer = [];
          let resp2 = await fetch('http://localhost:8080/group?code='+this.codice,
          {
            method: 'GET',
            headers: {'Content-Type': 'application/json'},
          });
          ...
          let resp3 = await fetch('http://localhost:8080/user?id='+this.gruppi[0].master,
            {
              method: 'GET',
              headers: {'Content-Type': 'application/json'},
              credentials:'include',
            ...
            for(let j=0; j<this.gruppi[0].characters.length; j++){
              ...
              let resp4 = await fetch('http://localhost:8080/user?id='+this.gruppi[0].characters[j].user,
              {
                method: 'GET',
                headers: {'Content-Type': 'application/json'},
                credentials:'include',
